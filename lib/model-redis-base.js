...
var ModelRedis = module.exports = Model.extend(function() {
  ...
  this.NS = config.opts.redis.namespace;
});
...
ModelRedis.getClient = function(optNew) {
  ...
  var port = config.opts.redis.main.port;
  var host = config.opts.redis.main.host;
  var pass = config.opts.redis.main.pass;
  var opts = config.opts.redis.main.options;
  var client;
